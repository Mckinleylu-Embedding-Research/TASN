...
class Graphormer(nn.Module):
    def __init__(self, dim, head_num, layer_num, num_class=7): # Cora node's class is 7
                                                               # 之前class是10
        super().__init__()
        """
        dim = hidden_dim
        ...
        """
        head_num is used in nn.Embedding(50, head_num).
                 is used in attention's nums_head = head_num as well.
        """
    ...
    def forward(self, x, edge_index, edge_attr, batch=1):
